        ...
        if emp_objective.status != status:
            ...
            notify.send(
                ...
                verb=f"The status of the objective '{emp_objective.objective_id}'\
                    has been changed to {emp_objective.status}.",
                verb_tr=f"'{emp_objective.objective_id}' hedefinin durumu {emp_objective.status} olarak değiştirildi.",
...
def send_feedback_notifications(request, form):
    ...
    if form.manager_id:
        ...
        notify.send(
            ...
            verb_tr="Bir geri bildirimde yönetici olarak atandınız!",
    ...
    if form.subordinate_id:
        ...
        for subordinate in subordinates:
            notify.send(
                ...
                verb_tr="Bir geri bildirimde ast olarak atandınız!",
    ...
    if form.colleague_id:
        ...
        for colleague in colleagues:
            notify.send(
                ...
                verb_tr="Bir geri bildirimde meslektaş olarak atandınız!",
            ...
            if feedback.based_on == "employee":
                try:
                    notify.send(
                        ...
                        verb_tr="Anonim bir geri bildirim aldınız!",
        ...
        if request.method == "POST":
            ...
            if emp_key_result.is_valid():
                ...
                notify.send(
                    ...
                    verb_tr="Bir Anahtar Sonuç aldınız!",
    ...
    if request.method == "POST":
        ...
        if emp_key_result.is_valid():
            ...
            notify.send(
                ...
                verb_tr="Anahtar Sonucunuz güncellendi.",
        ...
        if form.is_valid():
            ...
            try:
                notify.send(
                    ...
                    verb_tr=f"{instance.title} toplantısında sorumlu çalışan olarak eklendiniz.",
            ...
            try:
                notify.send(
                    ...
                    verb_tr=f"{instance.title} toplantısına eklendiniz.",
            ...
            try:
                notify.send(
                    ...
                    verb_tr=f"{instance.title} toplantısında yönetici olarak eklendiniz.",
