    ...
    if is_reportingmanger(request, attendance) or request.user.has_perm(
        ...
        with contextlib.suppress(Exception):
            notify.send(
                ...
                verb_tr=f"{attendance.employee_id}, {attendance.attendance_date} tarihli katılım için yeniden doğrulama talep etti",
...
def approve_overtime(request, obj_id):
    ...
    with contextlib.suppress(Exception):
        notify.send(
            ...
            verb_tr=f"{attendance.attendance_date} tarihli fazla mesainiz onaylandı.",
