    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            notify.send(
                ...
                verb_tr="Departmanınız bir gönderide mentionlandı.",
            ...
            notify.send(
                ...
                verb_tr="İş pozisyonunuz bir gönderide mentionlandı.",
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            notify.send(
                ...
                verb_tr=f"{anoun.title} duyurusu altında bir yorum yapıldı.",
