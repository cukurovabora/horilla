...
def mail_server_test_email(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            subject = _("Test mail from Göçtur MyHR")
            ...
            try:
                ...
                image_path = path.join(
                    settings.STATIC_ROOT, "images/ui/goctur_logo.png"
                )
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            notify.send(
                ...
                verb_tr="Rotasyonlu çalışma türüne eklendiniz.",
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            notify.send(
                ...
                verb_tr="Rotasyonlu vardiyaya eklendiniz.",
        ...
        if form.is_valid():
            ...
            try:
                notify.send(
                    ...
                    verb_tr=f"{instance.employee_id} için doğrulama talebiniz var.",
...
def work_type_request_cancel(request, id):
    ...
    notify.send(
        ...
        verb_tr="Çalışma türü talebiniz reddedildi.",
    ...
    for id in ids:
        ...
        if (
            ...
            notify.send(
                ...
                verb_tr="Çalışma türü talebiniz iptal edildi.",
                verb_ar="تم إلغاء طلب نوع وظيفتك.",
                verb_de="Ihre Arbeitstypanfrage wurde storniert.",
                verb_es="Su solicitud de tipo de trabajo ha sido cancelada.",
                verb_fr="Votre demande de type de travail a été annulée.",
...
def work_type_request_approve(request, id):
    ...
    if not work_type_request.is_any_work_type_request_exists():
        ...
        notify.send(
            ...
            verb_tr="Çalışma türü talebiniz onaylandı.",
...
def work_type_request_delete(request, obj_id):
    ...
    try:
        ...
        notify.send(
            ...
            verb_tr="Çalışma türü talebiniz silindi.",
        ...
        if form.is_valid():
            ...
            try:
                notify.send(
                    ...
                    verb_tr=f"{instance.employee_id} için onaylamanız gereken yeni bir vardiya tahsis talebiniz var.",
        ...
        if form.is_valid():
            ...
            try:
                notify.send(
                    ...
                    verb_tr=f"{instance.employee_id} tarafından yeni bir vardiya tahsis talebi var.",
...
def shift_request_cancel(request, id):
    ...
    notify.send(
        ...
        verb_tr="Vardiya talebiniz iptal edildi.",
    ...
    if shift_request.reallocate_to:
        notify.send(
            ...
            verb_tr="Vardiya talebiniz reddedildi.",
            verb_ar="تم إلغاء طلبك للوردية.",
            verb_de="Ihr Schichtantrag wurde storniert.",
            verb_es="Se ha cancelado su solicitud de turno.",
            verb_fr="Votre demande de quart a été annulée.",
...
def shift_request_approve(request, id):
    ...
    for recipient in recipients:
        notify.send(
            ...
            verb_tr="Vardiya talebiniz onaylandı.",
...
def shift_allocation_request_approve(request, id):
    ...
    if not shift_request.is_any_request_exists():
        ...
        notify.send(
            ...
            verb_tr=f"{request.user.employee_get} vardiya tahsisi için uygun.",
...
def shift_request_delete(request, id):
    ...
    try:
        ...
        notify.send(
            ...
            verb_tr="Vardiya talebiniz silindi.",
                ...
                if (
                    ...
                    if request.user.employee_get.id == shift.employee_id.id:
                        ...
                        notify.send(
                            ...
                            verb_tr=f"{shift.employee_id}'nin vardiya talebine bir yorum yapıldı.",
                        ...
                        notify.send(
                            ...
                            verb_tr="Vardiya talebinize bir yorum yapıldı.",
                ...
                if (
                    ...
                    if request.user.employee_get.id == work_type.employee_id.id:
                        ...
                        notify.send(
                            ...
                            verb_tr=f"{work_type.employee_id}'nin çalışma türü talebine bir yorum yapıldı.",
                        ...
                        notify.send(
                            ...
                            verb_tr="Çalışma türü talebinize bir yorum yapıldı.",
