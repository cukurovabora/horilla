...
#     # Update database from MS SQL
#     print("Getting data from MS SQL...")
#     data = sync_database_data()
#     print("Data retrieved successfully.")

#     # Process the data and insert/update records in PostgreSQL
#     for entry in data:
...
#         # Update or create records in PostgreSQL
...
scheduler.add_job(scheduled_sync_task, "interval", hours=1)
