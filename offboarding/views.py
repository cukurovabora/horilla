    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            notify.send(
                ...
                verb_tr="Offboarding yöneticisi olarak seçildiniz.",
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            notify.send(
                ...
                verb_tr="Offboarding aşaması yöneticisi olarak seçildiniz.",
        ...
        if form.is_valid():
            ...
            if not instance_id:
                notify.send(
                    ...
                    verb_tr=f"{stage.offboarding_id} offboarding'inin {stage} aşamasına eklendiniz.",
...
def delete_employee(request):
    ...
    if instances:
        ...
        notify.send(
            ...
            verb_tr="Offboarding sürecinden çıkarıldınız.",
...
def change_stage(request):
    ...
    notify.send(
        ...
        verb_tr="Offboarding aşaması değiştirildi.",
...
def update_task_status(request, *args, **kwargs):
    ...
    notify.send(
        ...
        verb_tr="Offboarding görev durumu güncellendi.",
    ...
    if status in ["approved", "rejected"]:
        for letter in letters:
            ...
            notify.send(
                ...
                verb_tr=f"İstifa talebi {letter.get_status_display()} olarak güncellendi.",
