    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            notify.send(
                ...
                verb_tr="Yeni bir talebe atandınız.",
    ...
    if ticket.status != status:
        if (
            ...
            notify.send(
                ...
                verb_tr=f"Talebin durumu {ticket.status} olarak değiştirildi.",
    ...
    if approve:
        ...
        if employee not in ticket.assigned_to.all():
            ...
            try:
                ...
                notify.send(
                    ...
                    verb_tr=f"Yeni bir talebe atandınız - {ticket}.",
                ...
                for emp in [ticket.created_by.employee_get, ticket.employee_id]:
                    try:
                        notify.send(
                            ...
                            verb_tr=f"{employee}, talebinize atandı - {ticket}.",
        ...
        if employee in ticket.assigned_to.all():
            ...
            notify.send(
                ...
                verb_tr=f"Talep-{ticket} için hak talebiniz reddedildi.",
