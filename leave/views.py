            ...
            if save:
                ...
                if multiple_approvals_check(leave_request.id):
                    ...
                    with contextlib.suppress(Exception):
                        notify.send(
                            ...
                            verb_tr="Onaylamanız gereken yeni bir izin talebi var.",
                ...
                with contextlib.suppress(Exception):
                    notify.send(
                        ...
                        verb_tr=f"{leave_request.employee_id} için yeni bir izin talebi oluşturuldu.",
            ...
            if save:
                ...
                with contextlib.suppress(Exception):
                    notify.send(
                        ...
                        verb_tr=f"{leave_request.employee_id} için izin talebi güncellendi.",
        ...
        if total_available_leave >= leave_request.requested_days:
            ...
            with contextlib.suppress(Exception):
                notify.send(
                    ...
                    verb_tr="İzin talebiniz onaylandı.",
            ...
            if leave_request.status != "rejected":
                ...
                with contextlib.suppress(Exception):
                    notify.send(
                        ...
                        verb_tr="İzin talebiniz reddedildi.",
        ...
        if new_employees:
            ...
            notifications = [
                notify.send(
                    ...
                    verb_tr="Yeni bir izin türü size atandı.",
        ...
        if form.is_valid():
            ...
            with contextlib.suppress(Exception):
                notify.send(
                    ...
                    verb_tr=f"{available_leave.leave_type_id} izin türünüz güncellendi.",
        ...
        if form.is_valid():
            ...
            with contextlib.suppress(Exception):
                notify.send(
                    ...
                    verb_tr=f"{leave_allocation_request.employee_id} için yeni bir izin tahsis talebi oluşturuldu.",
            ...
            if form.is_valid():
                ...
                with contextlib.suppress(Exception):
                    notify.send(
                        ...
                        verb_tr=f"{leave_allocation_request.employee_id} için izin tahsis talebi güncellendi.",
    ...
    if leave_allocation_request.status == "requested":
        ...
        with contextlib.suppress(Exception):
            notify.send(
                ...
                verb_tr="İzin tahsis talebiniz onaylandı.",
            ...
            if form.is_valid():
                ...
                with contextlib.suppress(Exception):
                    notify.send(
                        ...
                        verb_tr="İzin tahsis talebiniz reddedildi.",
                ...
                if (
                    ...
                    if request.user.employee_get.id == leave.employee_id.id:
                        ...
                        notify.send(
                            ...
                            verb_tr=f"{leave.employee_id} adlı kişinin izin talebine bir yorum yapıldı.",
                        ...
                        notify.send(
                            ...
                            verb_tr="İzin talebinize bir yorum yapıldı.",
                ...
                if (
                    ...
                    if request.user.employee_get.id == leave.employee_id.id:
                        ...
                        notify.send(
                            ...
                            verb_tr=f"{leave.employee_id} adlı kişinin izin tahsis talebine bir yorum yapıldı.",
                        ...
                        notify.send(
                            ...
                            verb_tr="İzin tahsis talebinize bir yorum yapıldı.",
            ...
            if comp_leave_req.status == "requested":
                ...
                with contextlib.suppress(Exception):
                    notify.send(
                        ...
                        verb_tr="Telafi izni talebiniz onaylandı.",
                ...
                if form.is_valid():
                    ...
                    with contextlib.suppress(Exception):
                        notify.send(
                            ...
                            verb_tr="Telafi izni talebiniz reddedildi.",
                    ...
                    if (
                        ...
                        if request.user.employee_get.id == comp_leave.employee_id.id:
                            ...
                            notify.send(
                                ...
                                verb_tr=f"{comp_leave.employee_id} adlı kişinin telafi izni talebine bir yorum yapıldı.",
                            ...
                            notify.send(
                                ...
                                verb_tr="Telafi izni talebinize bir yorum yapıldı.",
